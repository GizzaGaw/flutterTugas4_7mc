...
import 'package:simple_inventory/repository/data_repository.dart';
import 'package:simple_inventory/transaction/editProduct.dart';
    ...
    return Card(
      ...
      child: Row(
        children: <Widget>[
          ...
          IconButton(
            icon: Image(image: AssetImage('images/trash-can.png')),
            onPressed: () {
